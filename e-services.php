...
<body>
          ...
          <div class="card-body text-center">
            ...
            <p class="card-text">
              PUP IPMO offers Originality Checking through <strong>Turnit-in</strong>.<br>
                <li><b>15% - Graduate School (Doctorate and Masterals)</b></li>
                <li><b>20% and below - Undergraduate Degree</b></li>
              </ul>
            </p>
            <button class="btn btn-success" onclick="window.location.href='originality-check.php'">Apply</button>
          </div>
        </div>
      </div>
      <div class="col-md-4">
  ...
  <script src="e-services.js"></script>
</body>
</html>