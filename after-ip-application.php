...
<head>
  ...
  <link rel="stylesheet" href="css/after-ip-application.css">
</head>
<body>
  <!-- Navbar -->
<nav class="navbar navbar-expand-lg bg-white border-bottom">
      ...
      <div class="guide-card d-flex flex-wrap flex-xl-nowrap align-items-start mb-4">
        ...
        <div class="flex-grow-1 d-flex flex-column flex-md-row w-100">
          ...
          <div class="step-actions d-flex flex-column justify-content-center align-items-md-end align-items-start ms-md-3 mt-3 mt-md-0">
            <div class="mb-2 small text-center">You are already logged in.</div>
            <div class="d-flex gap-2">
              <!--<a href="#" class="btn btn-danger btn-sm fw-bold px-4">STUDENT</a>
              <a href="#" class="btn btn-danger btn-sm fw-bold px-4">EMPLOYEE</a> -->
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="javascript/after-ip-application.js"></script>
</body>
</html>