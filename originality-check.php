...
<head>
  ...
  <link rel="stylesheet" href="<?php echo asset_url('css/originality-check.css'); ?>">
</head>
<body>
  ...
  <img src="<?php echo asset_url('Photos/Icons/turnitin-icon.png'); ?>" alt="Turnitin" height="40" width="120" style="vertical-align:middle;">
    </p>
    <h4 class="fw-bold mt-4 mb-3">FAQs and Guide:</h4>
    <div class="bg-light rounded-3 p-3 mb-4">
      <div class="d-flex align-items-center mb-2">
  <img src="<?php echo asset_url('Photos/Icons/Originality-icon.png'); ?>" alt="Originality Icon" height="45" width="45" class="me-2">
    ...
    <div class="bg-light rounded-3 p-3 mb-4">
      <div class="d-flex align-items-center mb-2">
  <img src="<?php echo asset_url('Photos/Icons/desk-icon.png'); ?>" alt="Desk Icon" height="40" width="42" class="me-2">
