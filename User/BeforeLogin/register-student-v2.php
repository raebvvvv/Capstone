...
<head>
  ...
  <link rel="stylesheet" href="<?= APP_BASE_URL ?>/css/register-student-custom.css">
...
<body class="bg-light d-flex flex-column min-vh-100">
  ...
  <img src="<?= APP_BASE_URL ?>/Photos/account-registration-side (1).png" alt="Account Registration Design" />
      </div>
    </div>
  </main>
