...
<head>
  ...
  <link rel="stylesheet" href="<?= APP_BASE_URL ?>/css/originality-form.css">
...
<body>
  ...
  <img src="<?= APP_BASE_URL ?>/Photos/pup-logo.png" alt="PUP Logo" width="50" class="me-2">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item"><a class="nav-link active" aria-current="page" href="<?= APP_BASE_URL ?>/index.php">Home</a></li>
  ...
  <img src="<?= APP_BASE_URL ?>/Photos/originality-check-form.jpg" alt="Originality Check Form" class="form-img" style="width: auto; height: 645px;" />
    </div>
  </div>
  ...
  <script src="<?= APP_BASE_URL ?>/javascript/originality-form.js"></script>
</body>
</html>