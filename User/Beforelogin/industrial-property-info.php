...
<head>
  ...
  <link rel="stylesheet" href="../../css/copyright-info.css">
</head>
<body>
  <!-- Navigation Bar -->
      ...
      <div class="col-lg-9">
        ...
        <div id="introduction" class="info-card content-section">
          <div class="card-body">
            ...
            <p class="lead">
              Industrial property is one of the two main types of intellectual property, covering innovations, 
              industrial designs, trademarks, service marks, geographical indications, and other commercial identifiers.
            </p>
            <p>
              Industrial property includes patents for inventions, utility models for minor innovations, trademarks 
              for brand identification, and industrial designs for aesthetic aspects of products. These rights help 
              protect business interests and encourage innovation in commerce and industry.
            </p>
            <p>
              Unlike copyright (which protects artistic and literary works), industrial property focuses on protecting 
              inventions, brands, and commercial designs that have practical applications in business and industry.
            </p>
            
            <div class="highlight-box">
              <strong>Source Attribution:</strong> This information is based on content from the 
              <a href="https://www.wipo.int/en/web/patents" target="_blank" class="text-decoration-none">World Intellectual Property Organization (WIPO)</a>. 
              Content has been adapted for educational purposes at PUP e-IPMO.
            </div>
          </div>
        </div>

        <!-- PUP Definition Section -->
        <div id="pup-definition" class="info-card content-section">
          <div class="card-body">
            ...
            <div class="pup-highlight">
              ...
              <p class="mb-0">
                PUP's industrial property services facilitate the process of registration for <strong>patents, utility models, 
                trademarks, and industrial designs</strong> developed by students, faculty, and researchers. This ensures the 
                protection of innovations, brands, and commercial designs created within the university.
              </p>
            </div>
            
            <div class="highlight-box">
              <strong>Source Attribution:</strong> This information is based on the 
              <a href="https://drive.google.com/file/d/0B1BuDAuN0r8SbmFEU1RJUDFYU1E/view?resourcekey=0-ntyYkBAnyIFKdRJWhiKEcw" target="_blank" class="text-decoration-none">PUP Citizens Charter</a>. 
              Content has been adapted for educational purposes at PUP e-IPMO.
            </div>
          </div>
        </div>

        <!-- PUP Services Section -->
        ...
        <!-- Types of Industrial Property Section -->
        ...
        <div id="patents" class="info-card content-section">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <!-- Trademarks & Industrial Designs Details -->
              <div class="col-md-6">
        ...
        <div id="requirements" class="info-card content-section">
          <div class="card-body">
            ...
            <div class="highlight-box">
              <strong>Source Attribution:</strong> These patent requirements are based on standards from the 
              <a href="https://www.ipophil.gov.ph/services/patent/" target="_blank" class="text-decoration-none">Intellectual Property Office of the Philippines (IPOPhil)</a> 
              and international patent law principles. Content has been adapted for educational purposes at PUP e-IPMO.
            </div>
          </div>
        </div>
        ...
        <div id="application" class="info-card content-section">
          <div class="card-body">
            ...
            <div class="highlight-box">
              <strong>Source Attribution:</strong> Process information based on 
              <a href="https://www.ipophil.gov.ph/patent/" target="_blank" class="text-decoration-none">IPOPhil Patent Guidelines</a>. 
              Content adapted for educational purposes at PUP e-IPMO.
            </div>
          </div>
        </div>

        <!-- Protection Duration Section -->
        ...
        <div id="benefits" class="info-card content-section">
          <div class="card-body">
            ...
            <div class="highlight-box">
              <strong>Source Attribution:</strong> Benefits information compiled from 
              <a href="https://www.wipo.int/en/web/patents" target="_blank" class="text-decoration-none">WIPO Patent Resources</a> and 
              <a href="https://www.ipophil.gov.ph/services/patent/" target="_blank" class="text-decoration-none">IPOPhil Guidelines</a>. 
              Content adapted for educational purposes at PUP e-IPMO.
            </div>
          </div>
        </div>
        ...
        <div id="international" class="info-card content-section">
          <div class="card-body">
            ...
            <div class="highlight-box" style="background: #d4edda; border-color: #c3e6cb;">
              <strong>Philippines & International Patents:</strong> The Philippines is a member of WIPO and follows international 
              standards for patent protection. Filipino inventors can file both domestic and international patent applications.
            </div>
          </div>
        </div>

        <!-- Educational Resource Attribution Section -->
        <div id="attribution" class="info-card content-section">
          <div class="card-body text-center">
            <h6 class="fw-bold mb-3">Educational Resource Attribution</h6>
            <p class="small text-muted mb-3">
              <strong>Important Academic Disclaimer:</strong> This educational content is compiled from multiple authoritative 
              sources and has been adapted for educational purposes at the Polytechnic University of the Philippines e-IPMO system. 
              While we strive for accuracy, users should consult official sources for the most current information. This compilation 
              constitutes transformative educational use under applicable fair use provisions.
            </p>
  ...
  <!-- Table of Contents Navigation Script -->
  <script>
