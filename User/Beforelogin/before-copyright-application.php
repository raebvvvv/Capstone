  ...
  <main class="container py-4">
    ...
    <ol>
      <li class="mb-4">
        ...
        <a href="https://drive.google.com/uc?export=download&id=1njbAmgm2LrUSm2I5NPM9sFgPLbwnP_UH" 
    ...
    <div class="file-list">
      ...
      <div class="file-card">
        ...
        <div class="file-actions">
          <a href="https://drive.google.com/file/d/11KW9MmxtVCzsfsWa1r9ifg-0RBFP-hG-/view?usp=sharing" 
             target="_blank" class="btn btn-warning btn-sm mb-1">View File</a>
          <a href="https://drive.google.com/uc?export=download&id=11KW9MmxtVCzsfsWa1r9ifg-0RBFP-hG-" 
      ...
      <div class="file-card">
        ...
        <div class="file-actions">
          <a href="https://docs.google.com/document/d/11K-MlpSodpghHhPiB_q5YUpXlSdb_vgb/edit?usp=drive_link&ouid=104730774923126836253&rtpof=true&sd=true" 
             target="_blank" class="btn btn-warning btn-sm mb-1">View File</a>
          <a href="https://docs.google.com/document/d/11K-MlpSodpghHhPiB_q5YUpXlSdb_vgb/export?format=docx" 
             class="btn btn-danger btn-sm mb-1">Download as PDF</a>
        </div>
      </div>
      ...
      <div class="file-card">
        ...
        <div class="file-actions">
          <a href="https://drive.google.com/file/d/1FQVXIxyHQtpAp0dYZwxp5Rop850XRrIW/view?usp=drive_link" 
             target="_blank" class="btn btn-warning btn-sm mb-1">View File</a>
          <a href="https://drive.google.com/uc?export=download&id=1FQVXIxyHQtpAp0dYZwxp5Rop850XRrIW" 
             class="btn btn-danger btn-sm mb-1">Download as PDF</a>
        </div>
      </div>
      ...
      <div class="file-card">
        ...
        <div class="file-actions">
          <a href="https://docs.google.com/document/d/18Eq88--hxUbixZWGvd3LdEl6BzszfG0S/edit?usp=drive_link&ouid=104730774923126836253&rtpof=true&sd=true" 
             target="_blank" class="btn btn-warning btn-sm mb-1">View File</a>
          <a href="https://docs.google.com/document/d/18Eq88--hxUbixZWGvd3LdEl6BzszfG0S/export?format=docx" 
             class="btn btn-danger btn-sm mb-1">Download as PDF</a>
        </div>
      </div>
