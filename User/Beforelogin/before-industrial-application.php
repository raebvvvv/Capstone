...
<body>
  ...
  <div class="container d-flex justify-content-end mt-3 mb-2">
    <?php 
    // Render back button if the function exists
  ...
  <main class="container py-4">
    ...
    <!-- Instructions and ZIP file download -->
    <ol>
      <li class="mb-4">
        This ZIP file contains clean copies of all required files.<br>
        Files <strong>required</strong> to be printed have 
        <span class="text-success fw-bold">'[Print]'</span> in their filenames.<br>
        <a href="https://drive.google.com/uc?export=download&id=1JtRlzBU0S7DDaaXSr6yJJlZLo8C7pigy" 
           class="btn btn-primary mt-2 mb-2" 
           style="width:180px; background-color: #900c0c !important; border-color: #900c0c !important; color: #fff !important;">
           Industrial-Property.zip
        </a>
      </li>
      <li class="mb-4">
        Once printed and accomplished, please proceed to the 
        <strong>physical submission at the RMIPO in room S423, PUP Main.</strong>
      </li>
    </ol>
    ...
    <div class="file-list">
      ...
      <div class="file-card">
        ...
        <div class="file-info">
          <span class="fw-bold">
            1. Request letter / Letter of intent for IP application addressed to the director of IPMO 
            <span class="text-success">[Print]</span>
          </span>
        </div>
        <div class="file-actions">
          <!-- Optional View / Download buttons can go here -->
        </div>
      </div>
      ...
      <div class="file-card">
        ...
        <div class="file-info">
          <span class="fw-bold">
            2. Proof of copyright application / Certificate of copyright application from IPMO 
            <span class="text-success">[Print]</span>
          </span><br>
      ...
      <div class="file-card">
        ...
        <div class="file-info">
          <span class="fw-bold">
            3. Notarized deed of Assignment <span class="text-success">[Print]</span>
          </span>
        </div>
        <div class="file-actions">
      ...
      <!-- Repeat for remaining files (4,5,6) -->
      <div class="file-card">
        <div class="file-icon">&#128196;</div>
        <div class="file-info">
          <span class="fw-bold">4. Invention Disclosure Form <span class="text-success">[Print]</span></span>
        </div>
        <div class="file-actions">
      ...
      <div class="file-card">
        <div class="file-icon">&#128196;</div>
        <div class="file-info">
          <span class="fw-bold">5. Preliminary Search Report <span class="text-success">[Print]</span></span>
        </div>
        <div class="file-actions">
      ...
      <div class="file-card">
        <div class="file-icon">&#128196;</div>
        <div class="file-info">
          <span class="fw-bold">6. Two (2) copies of acknowledgement receipt of IP Application <span class="text-success">[Print]</span></span>
        </div>
        <div class="file-actions"></div>
      </div>
