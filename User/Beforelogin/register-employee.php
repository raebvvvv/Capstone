        ...
        <form method="POST" action="#" autocomplete="off" id="employeeRegForm" class="needs-validation" novalidate>
          <div class="row g-3 mb-2">
            ...
            <div class="col-md-2">
              ...
              <input type="text" class="form-control" id="middleName" name="middleName"  required pattern="[A-Za-z\.\- ]+" title="Only letters, spaces, hyphens (-), and dot (.) allowed">
              <div class="invalid-feedback">Please fill in this field.</div>
            </div>
            <div class="col-md-2">
              <label for="suffix" class="form-label">Suffix <span class="text-danger"></span></label>
              <input type="text" class="form-control" id="suffix" name="suffix" maxlength="10"  pattern="[A-Za-z\.]+" title="Up to 10 characters and dots (.) allowed">
