...
<head>
  ...
  <link href="css/after-about.css" rel="stylesheet">
</head>
<body>
  <!-- Navbar -->
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item"><a class="nav-link fw-bold" href="after-about.php">About Us</a></li>
  ...
  <main class="container py-5">
    <div class="row mb-5 gx-3 gy-4">
      ...
      <div class="col-lg-7 px-3">
        <h1 class="fw-bold mb-3">Intellectual Property Management Office</h1>
      ...
      <!-- Office/Location/Contact Column - Move further right on desktop -->
      <div class="col-lg-5 px-3">
        <div class="custom-push-right">
