    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item"><a class="nav-link nav-bold" aria-current="page" href="after-landing.php">Home</a></li>
         <li class="nav-item"><a class="nav-link nav-bold active-page" aria-current="page" href="after-about.php">About Us</a></li>
    ...
    <div class="row g-5 align-items-start">
      <div class="col-lg-5">
        <h1 class="fw-bold mb-2">e-IPMO Services</h1>
          <p class="mb-3 p-font-size"> The <span class="fw-bold">Intellectual Property Management Office (IPMO)</span> of the Polytechnic University 
          of the Philippines provides assistance to researchers to secure attractive returns in the long term from the bulk of valuable research 
          outcomes and intellectual prsoperty. It also assists researchers in identifying partners within the academe, other businesses and 
          investors to promote translation of research innovations into new products through advice and support for early-stage research and 
          development. <br> <br>The IPMO provides a portfolio of new technologies created through University research for licensing or collaborative development.
          </p>
      </div>
      <div class="col-lg-7">
        <div class="office-right">
          ...
          <div class="mb-2">
            <span class="me-3"><img src="Photos/Icons/Email-icon.png" alt="email" style="width:20px;height:20px;vertical-align:middle;margin-right:4px;"> ipmo@pup.edu.ph</span><br>
            <span><img src="Photos/Icons/Landline-icon.png" alt="phone" style="width:20px;height:20px;vertical-align:middle;margin-right:4px;"> (+632) 5335-1787</span>
          </div>
          </div>
        </div>
      </div>
