...
try{
  ...
  $st = $pdo->prepare('SELECT id, title, message, meta, is_read, created_at, deleted_at FROM user_notifications WHERE user_id = ? AND deleted_at IS NOT NULL ORDER BY deleted_at DESC LIMIT ?');
