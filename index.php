...
<head>
  ...
  <link rel="stylesheet" href="<?= APP_BASE_URL ?>/css/landing.css">
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item"><a class="nav-link active maroon-underline" aria-current="page" href="<?= APP_BASE_URL ?>/index.php">Home</a></li>
  ...
  <div class="row g-5 align-items-start">
    <div class="d-flex flex-row justify-content-between align-items-start w-100 flex-wrap main-intro-row">
      <div class="d-flex flex-row justify-content-between align-items-start w-100 flex-wrap">
        <div class="flex-grow-1" style="max-width: 60%;">
          ...
          <p class="mb-2">
            <span class="me-3"><img src="<?= APP_BASE_URL ?>/Photos/Icons/Email-icon.png" alt="email" class="icon-sm"> ipmo@pup.edu.ph</span>
            <span><img src="<?= APP_BASE_URL ?>/Photos/Icons/Landline-icon.png" alt="phone" class="icon-sm"> (+632) 5335-1787</span>
          </p>
    ...
    <div class="d-flex flex-column align-items-center w-100 mt-4">
      <div class="cards-center-row">
        <div class="card shadow-sm h-100">
          <div class="card-body text-center">
            <img src="<?= APP_BASE_URL ?>/Photos/Icons/who.png" alt="users" class="mb-3 mx-auto d-block" style="height:40px;">
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body text-center">
            <img src="<?= APP_BASE_URL ?>/Photos/Icons/how-apply.png" alt="apply" class="mb-3 mx-auto d-block" style="height:40px;">
            <h5 class="fw-bold mb-2">How do I apply for IP?</h5>
            <div class="d-flex justify-content-center gap-2 mb-2">
              <a href="<?= APP_BASE_URL ?>/user/BeforeLogin/ip-application.php" class="btn btn-warning fw-bold">IP Application</a>
              <a href="<?= APP_BASE_URL ?>/user/BeforeLogin/before-originality-check.php" class="btn btn-warning fw-bold">Originality Check</a>
            </div>
          </div>
        </div>
        <div class="card shadow-sm h-100">
          <div class="card-body text-center">
            <img src="<?= APP_BASE_URL ?>/Photos/Icons/what-ip.png" alt="types" class="mb-3 mx-auto d-block" style="height:40px;">
      ...
      <div class="login-section-center">
        ...
        <div class="d-flex">
          <a href="<?= APP_BASE_URL ?>/user/BeforeLogin/login.php" class="btn btn-login fw-bold px-5 py-2">STUDENT</a>
          <a href="<?= APP_BASE_URL ?>/user/BeforeLogin/login.php" class="btn btn-login fw-bold px-5 py-2">EMPLOYEE</a>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card announcement-card">
          <img src="<?= APP_BASE_URL ?>/Photos/hiring.jpg" class="announcement-img" alt="Hiring Announcement">
        </div>
      </div>
      <div class="col-md-4">
        <div class="card announcement-card">
          <img src="<?= APP_BASE_URL ?>/Photos/hiring2.jpg" class="announcement-img" alt="Application Process">
        </div>
      </div>
      <div class="col-md-4">
        <div class="card announcement-card">
          <img src="<?= APP_BASE_URL ?>/Photos/hiring3.jpg" class="announcement-img" alt="Technical Assistant I">
        </div>
      </div>
      <div class="col-md-4">
        <div class="card announcement-card">
          <img src="<?= APP_BASE_URL ?>/Photos/hiring4.jpg" class="announcement-img" alt="Technical Assistant III">
        </div>
      </div>
      <div class="col-md-4">
        <div class="card announcement-card">
          <img src="<?= APP_BASE_URL ?>/Photos/hiring5.jpg" class="announcement-img" alt="Technical Expert">
        </div>
      </div>
      <div class="col-md-4">
        <div class="card announcement-card">
          <img src="<?= APP_BASE_URL ?>/Photos/hirinh6.jpg" class="announcement-img" alt="Technical Expert">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="container py-5" id="policy">
    ...
    <div class="row g-3">
      <div class="col-md-6">
  <img src="<?= APP_BASE_URL ?>/Photos/memo 1.png" class="img-fluid rounded shadow-sm" alt="Memo 1">
      </div>
      <div class="col-md-6">
  <img src="<?= APP_BASE_URL ?>/Photos/memo 2.png" class="img-fluid rounded shadow-sm" alt="Memo 2">
      </div>
    </div>
  </section>
  ...
  <section class="container py-6" id="articles">
    ...
    <div class="row g-4">
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <img src="<?= APP_BASE_URL ?>/Photos/article 1.png" class="card-img-top" alt="Article 1">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <img src="<?= APP_BASE_URL ?>/Photos/article 2.png" class="card-img-top" alt="Article 2">
          <div class="card-body">
      ...
      <div class="col-md-4">
        <div class="card shadow-sm h-100">
          <img src="<?= APP_BASE_URL ?>/Photos/article 3.png" class="card-img-top" alt="Article 3">
          <div class="card-body">
  ...
  <script src="<?= APP_BASE_URL ?>/javascript/landing.js"></script>
</body>
</html>